	        ...
	        <div class="container-fluid">
	            <div class="row mb-2">
	                <div class="col-sm-6">
	                    ...
	                    <a href="{{ route('admin.categories.create') }}" class="btn btn-primary mt-2"><i class="nav-icon fa fa-plus"></i> Add Category</a>
	                </div><!-- /.col -->
	                            		...
	                            		<table id="categories" class="table table text-center">
						            		...
						            		<tbody>
						            			@foreach($categories as $category)
													<tr>
														<td>{{ $category->id }}</td>
														<td><img src="{{ $category->renderImage() }}" alt="" height="100px" width="100px"></td>
														<td>{{ $category->name }}</td>
														<td>
															<a href="{{ route('admin.categories.show', $category->id) }}" class="btn btn-primary"><i class="far fa-eye"></i></a>
